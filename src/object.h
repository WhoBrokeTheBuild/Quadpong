...
object_get_sprite(object_t * obj)
{
    return &obj->_sprite;
}

static inline color_t
object_get_color(object_t * obj)
{
    return sprite_get_color(&obj->_sprite);
}
static inline void
object_set_color(object_t * obj, color_t color)
{
    sprite_set_color(&obj->_sprite, color);
}

static inline vec2f_t
object_get_vel(object_t * obj)
{
    return obj->_vel;
}
...
object_get_bounding_box(object_t * obj)
{
