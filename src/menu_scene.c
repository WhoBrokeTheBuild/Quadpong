...
menu_scene_init(menu_scene_t * mscn)
{
    ...
    menu_ptr = menu_option_add_sub_option(&mscn->root_option_group, "Local Game",
                                          &option_local_game_cb, root_mpos);
    ...
    menu_ptr = menu_option_add_sub_option(&mscn->root_option_group, "Connect to Game",
                                          &option_connect_game_cb, root_mpos);
    root_mpos.y += MENU_OPTION_HEIGHT;
    ...
    menu_option_add_sub_option(menu_ptr, "Toggle FPS Displayed", &option_toggle_show_fps_cb,
                               opt_mpos);

    menu_ptr =
        menu_option_add_sub_option(&mscn->root_option_group, "Quit", &option_quit_cb, root_mpos);
    root_mpos.y += MENU_OPTION_HEIGHT;
}
