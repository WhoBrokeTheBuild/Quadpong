...
void
object_cleanup(object_t * obj)
{
    sprite_cleanup(&obj->_sprite);
}

void
object_update(object_t * obj, game_time_t * gt)
{
...
void
object_render(object_t * obj)
{
    sprite_render(&obj->_sprite);
}

void
object_set_pos(object_t * obj, vec2f_t pos)
{
    obj->_pos = pos;
...
void
object_set_vel(object_t * obj, vec2f_t vel)
{
    obj->_vel = vel;
}
